  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Gerçek Zamanlı Gelir Değeri</h2>
        <Tooltip className="ml-2">
          <div className="text-xs text-center whitespace-nowrap">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur architecto error sed animi atque sequi eveniet, delectus consectetur vitae, sint illum veritatis eos cumque quo aliquam iusto voluptate fugiat voluptatem.</div>
        </Tooltip>
      </header>
