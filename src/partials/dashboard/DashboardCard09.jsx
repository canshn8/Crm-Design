  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Satışlar ve İadeler</h2>
        <Tooltip className="ml-2" size="lg">
          <div className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus accusamus earum dignissimos fugit asperiores eos laborum tempora culpa eius labore minus quisquam quasi dolores beatae sit libero amet, incidunt perspiciatis..</div>
        </Tooltip>
      </header>
